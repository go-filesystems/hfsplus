...
// OpenReader opens the HFS+ volume at the start of r, exactly as Open does, and
...
// right shape but returns a concrete *Volume, which is a different type and does
